...
<body>
  <form action="" method="post">
    ...
    <div class="form-group fullname">
      <label for="fullname">Delivery Person Name</label>
    ...
    $(document).ready(function () {
        $('#category').change(function () {
            ...
            if (selectedCategory !== "") {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'get_foods copy.php', // Replace with the correct path to your PHP script
        ...
        $('#items').change(function () {
            ...
            if (selectedFood !== "") {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'get_price copy.php', // Replace with the correct path to your PHP script
